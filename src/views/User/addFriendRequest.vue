<template>
  ...
  <main class="content-box">
    ...
    <div style="width: 100%; text-align: center;">
      <van-button class="submit-btn" type="primary" size="large">发送</van-button>
    </div>
  </main>
</template>
...
import { NavBar, CellGroup, Cell, Field, Image, Button, showFailToast } from 'vant'
...
export default {
  ...
  setup (props) {
    ...
    return { message, info, goBack, getProfile }
  }
}
</script>
